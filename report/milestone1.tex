...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../results/trace_rep1/graphs/throughput.pdf}
\label{fig:rep1:throughput}
\caption{Throughput trace of the middleware without replication \todo{}.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../results/trace_rep1/graphs/responsetime.pdf}
\label{fig:rep1:responsetime}
\caption{Response time trace of the middleware with no replication \todo{}.}
\end{figure}
