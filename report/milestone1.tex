...
\todo{Mention thread pool, ExecutorService, and number of threads I use.}
...
See Figure~\ref{fig:baseline:throughput}.

\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{../results/baseline/graphs/throughput.pdf}
\label{fig:baseline:throughput}
\caption{Throughput of memcached without middleware, as measured by memaslap.}
\end{figure}

\subsection{Response time}\label{sec:baseline:rt}

See Figure~\ref{fig:baseline:responsetime}.
...
\caption{Response time of memcached without middleware, as measured by memaslap.}
\end{figure}
...
\todo{explain that first 5 minutes of experiment are not shown in graph -- warmup phase}
