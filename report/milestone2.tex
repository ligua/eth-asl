...
\caption{Response time to \textbf{GET} requests as a function of $W$, for different values of $S$ and $R$. The line and points show the mean response time; red errorbars show the 95\% confidence interval in a double-tailed t-test; the green area shows the 5\% (bottom edge) and 95\% (top edge) quantiles of response times.}
...
\caption{Response time to \textbf{SET} requests as a function of $W$, for different values of $S$ and $R$. The line and points show the mean response time; red errorbars show the 95\% confidence interval in a double-tailed t-test; the green area shows the 5\% (bottom edge) and 95\% (top edge) quantiles of response times.}
...
\caption{Relative performance for different values of $S$ and $R$: the response time of each setup relative to (divided by) the response time in the base case. The base case is taken to be $W=1\%$ in each plot.
