...
\todo{mention that below 432 clients (with T=32) throughput is significantly less than with 432} (explains why I don’t pick a lower value of C that has throughput in a similar range)
