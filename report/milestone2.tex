...
\caption{Throughput as a function of number of clients for different values of $T$. Errorbars show the 95\% confidence interval around the mean value which is shown with points connected by lines.}
\label{fig:exp1:res:throughput}
\end{figure}

\todo{table of top 3 parameter sets} with mean throughputs and confidence intervals?

\todo{confirm that throughput was sustained} -- response time was still reasonable and throughput did not decrease over time
