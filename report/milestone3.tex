...
\input{../results/analysis/part4_2k/coefficient_table.txt}
...
\caption{\todo{} what is red line; ribbon shows for M=3, i.e. if we made 3 FUTURE experiments, what would the stdev be. see Ch 18.}
\label{fig:part4:actual_and_predicted_vs_servers_and_writes}
\end{figure}

error is explained by huge variation -- up to 2000 req/s. I ran 2 of the 3 repetitions on the same day and the remaining one 3 days earlier, so it can't be that Azure was biased on one day when I measured but not on the other.
