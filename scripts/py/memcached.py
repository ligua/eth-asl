...
class Memcached(object):
    def __init__(self, serve_port, ssh_ip,
        ...
        self.host_string = "{}@{}".format(self.ssh_username, self.ssh_ip)
...
if __name__ == "__main__":
    m = Memcached(12345, "pungastsoft-violet-2439foraslvms1.westeurope.cloudapp.azure.com")